			  ...
			  <div class='col-xs-12'>
					<?php 
						if(isset($_GET['id']))
						{
							$id = $_GET['id'];
							$con = conectar ();
							$consulta = "select * from monitor where dni='$id'";
							
							$datos = mysqli_query($con, $consulta);
							$fila=mysqli_fetch_array($datos, MYSQLI_ASSOC);
							echo "<br><br><br><br><br><h2 class='sectionTitle'>MODIFICAR MONITOR</h2>";
							//echo "<div class='container' style='text-align: center; height: 50vh; display:flex; align-items:center;'>";
							echo "<center><img src='../imagenes/monitores/$fila[foto]' class='img-circle' height='200px' width='200px'></center>";
