			...
			<div class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
				<div class='container'>
					...
					<div id= 'navbar' class='navbar-collapse collapse'>
						<ul class='nav navbar-nav'>
							<li > 
							 <a href="insertarnoticia.php" > INSERTAR NOTICIAS  </a>															
							</li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
			...
			<div class='row'>
			  <div class='col-xs-12'>
					<?php 
							...
							echo "<BR><h2 class='sectionTitle'>NUEVA NOTICIA</h2>";
							echo "<form action='#' method='post' enctype='multipart/form-data'>
									<div class='inputContainer'>
										...
										<label>Noticia</label>
										<textarea name='contenido' class='form-control' autocomplete='off' ></textarea>
						...
						if(isset($_POST['enviar']))
						{
							...
							$id="select id_noticia from noticias order by id_noticia desc limit 1";
							$datos = mysqli_query($con, $id);
							$fila = mysqli_fetch_array($datos);
							$id = $fila['id_noticia']+1;
							...
							$consulta = "insert into noticias values (null, '$titulo', '$noticia', '$nom_foto')";
							
							
							mysqli_query($con, $consulta);
							if(mysqli_affected_rows($con)==1)
							{
								echo "<h3><center>Nueva noticia insertada correctamente</center></h3>";
								move_uploaded_file($foto, "../noticias/$nom_foto");
							}
							mysqli_close($con);
						}
					?>
