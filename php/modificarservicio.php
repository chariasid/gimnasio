			...
			<div class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
				<div class='container'>
					...
					<div id= 'navbar' class='navbar-collapse collapse'>
						<ul class='nav navbar-nav'>
							<li > 
							 <a href="insertarservicio.php" > INSERTAR SERVICIOS  </a>															
							</li>	
							<li > 
							 <a href="buscarservicio.php" > BUSCAR SERVICIOS  </a>															
							</li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
			  ...
			  <div class='col-xs-12'>
					<?php 
						if(isset($_GET['id']))
						{
							...
							echo "<h2 class='sectionTitle'>MODIFICAR SERVICIO</h2>";
							echo "<form action='#' method='post'>
									<div class='inputContainer'>
										<label>Servicio</label>
										<input type='text' name='nombre'  class='form-control' autocomplete='off' value='$fila[descripcion]'/>
										
										<label>Duración (minutos)</label>
										<input type='text' name='duracion'  class='form-control' autocomplete='off' value='$fila[duracion]'/>
									
										<label>Precio</label>
										<input type='text' name='precio' class='form-control' autocomplete='off' value='$fila[precio]' />
										
										<input type='hidden' name='id' value='$fila[id_servicio]'>
									</div>
									<br>
						...
						if(isset($_POST['enviar']))
						{
							...
							$con = conectar ();
							$consulta = "update servicios set descripcion='$nombre', duracion='$duracion', precio=$precio where id_servicio=$id";
