			...
			<div class='row'>
			  <div class='col-xs-12'>
					<?php 
							...
							echo "<h2 class='sectionTitle'>BUSCAR SERVICIO</h2>";
							echo "<form action='#' method='post' enctype='multipart/form-data'>
									<div class='inputContainer'>
										<label>Nombre / Duracion del servicio</label>
						...
						if(isset($_POST['enviar']))
						{
							...
							$con = conectar();
							$consulta = "select * from servicios where descripcion like '%$nombre%' or duracion like '%$nombre%' order by id_servicio desc";
