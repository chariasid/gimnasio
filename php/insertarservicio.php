			...
			<div class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
				<div class='container'>
					...
					<div id= 'navbar' class='navbar-collapse collapse'>
						<ul class='nav navbar-nav'>
							<li > 
							 <a href="insertarproducto.php" > INSERTAR SERVICIOS  </a>															
							</li>	
							<li > 
							 <a href="buscarproducto.php" > BUSCAR SERVICIOS  </a>															
							</li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
			...
			<div class='row'>
			  <div class='col-xs-12'>
					<?php 
							...
							echo "<h2 class='sectionTitle'>NUEVO SERVICIO</h2>";
							echo "<form action='#' method='post' enctype='multipart/form-data'>
									<div class='inputContainer'>
										...
										<input type='text' name='duracion'  class='form-control' autocomplete='off'/>
						...
						if(isset($_POST['enviar']))
						{
							...
							$consulta = "insert into servicios values (null, '$nombre', '$duracion', $precio)";
							
							
							mysqli_query($con, $consulta);
							if(mysqli_affected_rows($con)==1)
							{
								echo "<h3><center>Nuevo servicio insertado correctamente</center></h3>";
