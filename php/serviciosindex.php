	...
	<html lang="es">
		...
		<body>
			...
			<div class="container" style="text-align: center; height: 50vh; display:flex; align-items:center;">
				<div class="col-xs-12">
					<h1>CLÍNICA VETERINARIA CANIX</h1>
					<h2>Se sentirán como en casa</h2>
				  <a class="btn btn-lg btn-success actionBtn" href="../index.php#empresa" style="background:#4ad5ce!important; border:none!important;"><span class="line2"></span><i class="fa fa-arrow-down" aria-hidden="true"></i></a>
				</div>
