			...
			<div class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
				<div class='container'>
					...
					<div id= 'navbar' class='navbar-collapse collapse'>
						<ul class='nav navbar-nav'>
							<li > 
							 <a href='clientes.php' > INSERTAR CLIENTES  </a>															
							</li>	
							<li > 
							 <a href='productos.php' > BUSCAR CLIENTES  </a>															
							</li>
							<li > 
							 <a href='servicios.php' > BORRAR CLIENTES  </a>															
							</li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
			  ...
			  <div class='col-xs-12'>
					<?php 
						if(isset($_GET['id']))
						{
							...
							{
								echo "<h3><center>CLIENTE ELIMINADO</center></h3>";
