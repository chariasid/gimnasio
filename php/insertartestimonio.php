			...
			<div class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
				<div class='container'>
					...
					<div id= 'navbar' class='navbar-collapse collapse'>
						<ul class='nav navbar-nav'>
							<li > 
							 <a href="insertartestimonio.php" > INSERTAR TESTIMONIOS  </a>															
							</li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
			...
			<div class='row'>
			  <div class='col-xs-12'>
					<?php 
							...
							echo "<h2 class='sectionTitle'>NUEVO TESTIMONIO</h2>";
							echo "<form action='#' method='post'>
									<div class='inputContainer'>
										<label>Autor</label>
										<input type='text' name='autor'  class='form-control' autocomplete='off'/>
						...
						if(isset($_POST['enviar']))
						{
							...
							$consulta = "insert into testimonios values (null, '$autor', '$contenido', '$fecha')";
							
							
							mysqli_query($con, $consulta);
							if(mysqli_affected_rows($con)==1)
							{
								echo "<h3><center>Nuevo testimonio insertado correctamente</center></h3>";
