			  ...
			  <div class='col-xs-12'>
					<?php 
						if(isset($_GET['id']))
						{
							...
							echo "<h2 class='sectionTitle'>MODIFICAR CLIENTE</h2>";
							...
							echo "<BR><BR><BR><img src='../clientes/$fila[foto]'>";
							...
							echo "<form action='#' method='post'>
									<div class='inputContainer'>
										...
										<input type='text' name='tipo_animal' class='form-control' autocomplete='off' value='$fila[tipo_animal]' />
										
										<label>Edad</label>
										<input type='text' name='edad' class='form-control' autocomplete='off' value='$fila[edad]' />
										
										<label>Nombre del dueño</label>
										<input type='text' name='nombre_duenio' class='form-control' autocomplete='off' value='$fila[nombre_dueño]' />
										
										<label>Teléfono del dueño</label>
										<input type='text' name='tlf_duenio' class='form-control' autocomplete='off' value='$fila[tlf_dueño]' />
						...
						if(isset($_POST['enviar']))
						{
							...
							$con = conectar ();
							$consulta = "update clientes set nombre='$nombre', tipo_animal='$tipo_animal', edad=$edad, nombre_dueño='$nombre_dueño', tlf_dueño='$tlf_dueño' where id_cliente=$id";
